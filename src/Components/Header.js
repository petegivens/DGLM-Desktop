      ...
      <div id="background">
        <div className="background-filter">
          ...
          <ul>
            ...
            <li id="devices" className="bounceInLeft">
              <img
                alt=""
                style={{
                  height: 45,
              ...
              <img
                alt=""
                style={{ height: 45, width: 160, padding: 0, margin: 0 }}
                src="https://www.oakgov.com/sheriff/PublishingImages/Pages/Mobile-Patrol-Application/googlePlay.png"
              />
            </li>
